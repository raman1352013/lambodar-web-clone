...
const PageLoader = () => {
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background">
      ...
      <h2 className="font-heading text-lg font-bold tracking-tight text-foreground">LambodraGroup</h2>
      <p className="mt-1.5 text-sm text-muted-foreground"> lambodraGroup...</p>
